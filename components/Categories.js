  ...
  return (
    <>
      <div className="md:h-[calc(100dvh-100px)] flex flex-col md:flex-row justify-center items-center space-y-4 md:space-x-10 md:items-center p-4">
        <Link className="relative hover:scale-[1.05] transition-all" href="/products/image">
        ...
        <Link className="relative hover:scale-[1.05] transition-all" href="/products/video">
